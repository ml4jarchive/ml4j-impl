...
public class UncompletedBatchNormAxons3DBuilderImpl<C extends Axons3DBuilder<?>>
	...
	@Override
	public UncompletedBatchNormAxonsBuilder<Neurons3D, C> withGamma(WeightsVector gamma) {
		this.gamma = gamma;
		return this;
	}

	@Override
	public UncompletedBatchNormAxonsBuilder<Neurons3D, C> withBeta(BiasVector beta) {
		this.beta = beta;
		return this;
	}

	@Override
	public UncompletedBatchNormAxonsBuilder<Neurons3D, C> withMean(FeaturesVector mean) {
		this.mean = mean;
		return this;
	}

	@Override
	public UncompletedBatchNormAxonsBuilder<Neurons3D, C> withVariance(FeaturesVector variance) {
	...
	@Override
	public UncompletedBatchNormAxonsBuilder<Neurons3D, C> withBiases(BiasVector biases) {
	...
	@Override
	public BatchNormDimension<Neurons3D> getBatchNormDimension() {
