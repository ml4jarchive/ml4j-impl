...
public class DummyFullyConnectedAxonsImpl implements FullyConnectedAxons {
	...
	public AxonsActivation pushLeftToRight(NeuronsActivation leftNeuronsActivation,
		...
		return new AxonsActivationImpl(this, null, leftNeuronsActivation, new NeuronsActivationImpl(matrixFactory.createMatrix(rightNeurons.getNeuronCountExcludingBias(), leftNeuronsActivation.getActivations(matrixFactory).getColumns()), NeuronsActivationFeatureOrientation.ROWS_SPAN_FEATURE_SET), leftNeurons, rightNeurons, false);
	}
	...
	public AxonsActivation pushRightToLeft(NeuronsActivation rightNeuronsActivation,
		...
		return new AxonsActivationImpl(this, null, rightNeuronsActivation, new NeuronsActivationImpl(matrixFactory.createMatrix(leftNeurons.getNeuronCountExcludingBias(), rightNeuronsActivation.getActivations(matrixFactory).getColumns()), NeuronsActivationFeatureOrientation.ROWS_SPAN_FEATURE_SET), leftNeurons, rightNeurons, false);
	}
