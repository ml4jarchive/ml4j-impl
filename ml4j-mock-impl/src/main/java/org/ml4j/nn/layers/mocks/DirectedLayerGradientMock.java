...
/**
 * Mock implementation of DirectedLayerGradient.
 * 
 * @author Michael Lavelle
 */
public class DirectedLayerGradientMock implements DirectedLayerGradient {

  private List<DirectedSynapsesGradient> directedSynapsesGradients;

  public DirectedLayerGradientMock(List<DirectedSynapsesGradient> directedSynapsesGradients) {
    this.directedSynapsesGradients = directedSynapsesGradients;
  }

  @Override
  public List<DirectedSynapsesGradient> getSynapsesGradients() {
    return directedSynapsesGradients;
  }
