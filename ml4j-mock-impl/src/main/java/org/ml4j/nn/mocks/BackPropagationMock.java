...
/**
 * Mock implementation of BackPropagation.
 * 
 * @author Michael Lavelle
 */
public class BackPropagationMock implements BackPropagation {

  private List<DirectedLayerGradient> directedLayerGradients;

  public BackPropagationMock(List<DirectedLayerGradient> directedLayerGradients) {
