...
/**
 * A skeleton Matrix impl for structural purposes.
 * 
...
public class MatrixImpl implements Matrix {
  ...
  /**
   * Construct a new MatrixImpl in the specified shape.
   * 
  ...
  public Matrix getRow(int rowIndex) {
    return new MatrixImpl(new double[][] {data[rowIndex] });
  }
  ...
  public Matrix sigmoid() {
    ...
    return new MatrixImpl(dataArray);
  }
