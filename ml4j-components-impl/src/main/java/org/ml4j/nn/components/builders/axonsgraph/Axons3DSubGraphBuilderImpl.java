...
public class Axons3DSubGraphBuilderImpl<P extends Axons3DGraphBuilder<P, Q>, Q extends AxonsGraphBuilder<Q>>
	...
	public Axons3DSubGraphBuilderImpl(Supplier<P> parentGraph, Supplier<Q> parentNon3DGraph, DirectedAxonsComponentFactory directedAxonsComponentFactory, Base3DGraphBuilderState builderState,
	...
	public AxonsSubGraphBuilder<Q> getBuilder() {
		if (builder != null) {
			...
			builder = new AxonsSubGraphBuilderImpl<>(parentNon3DGraph,  directedAxonsComponentFactory,
	...
	protected Axons3DSubGraphBuilder<P, Q> createNewNestedGraphBuilder() {
		return new Axons3DSubGraphBuilderImpl<>(parent3DGraph,
				parentNon3DGraph, directedAxonsComponentFactory, initialBuilderState, new ArrayList<>());
	}
