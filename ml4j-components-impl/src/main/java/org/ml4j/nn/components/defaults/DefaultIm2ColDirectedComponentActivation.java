...
public class DefaultIm2ColDirectedComponentActivation implements ChainableDirectedComponentActivation<NeuronsActivation> {

	private ImageNeuronsActivation output;
	
	public DefaultIm2ColDirectedComponentActivation(ImageNeuronsActivation output) {
		this.output = output;
	}
