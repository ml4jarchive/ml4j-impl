...
public class DirectedAxonsComponentImpl<L extends Neurons, R extends Neurons> 
  ...
  public DirectedAxonsComponentActivation forwardPropagate(NeuronsActivation inputNeuronsActivation,
    ...
    LOGGER.debug("Forward propagating through DirectedAxonsComponent:" + inputNeuronsActivation.getFeatureCount() + ":" + inputNeuronsActivation.getExampleCount());
    AxonsActivation axonsActivation = 
        axons.pushLeftToRight(inputNeuronsActivation, null, 
            axonsContext);   
    
    //inputNeuronsActivation.getActivations().close();
    
    return new DirectedAxonsComponentActivationImpl(this, axonsActivation, axonsContext);
...
public String toString() { return axons.getClass().getName() + ":" + axons.getLeftNeurons().getNeuronCountIncludingBias() + ":" + axons.getRightNeurons().getNeuronCountIncludingBias(); }
