...
public class Axons3DGraphSkipConnectionBuilderImpl<P extends Axons3DGraphBuilder<P, Q>, Q extends AxonsGraphBuilder<Q>>
	...
	public Axons3DGraphSkipConnectionBuilderImpl(Supplier<P> parent3DGraph, Supplier<Q> parentNon3DGraph, DirectedAxonsComponentFactory directedAxonsComponentFactory,
	...
	public AxonsGraphSkipConnectionBuilder<Q> getBuilder() {
		if (builder != null) {
			...
			builder =  new AxonsGraphSkipConnectionBuilderImpl<>(parentNon3DGraph, directedAxonsComponentFactory,
	...
	protected Axons3DGraphSkipConnectionBuilder<P, Q> createNewNestedGraphBuilder() {
		return new Axons3DGraphSkipConnectionBuilderImpl<>(parent3DGraph, parentNon3DGraph, directedAxonsComponentFactory, initialBuilderState, new ArrayList<>());
	}
}
